...
import 'package:mesadeservicio/utils/widgets_imss.dart';
import 'package:mesadeservicio/routes/route_name.dart';

class EstImssPage extends StatelessWidget{
  ...
  EstImssPage({super.key,required this.tema});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  WidgetsIMSS.getFieldNSS(nss),
                  const SizedBox(height: 10),
                  WidgetsIMSS.getFieldMotivos(motivo),
                  const SizedBox(height: 10),
  ...
  ApiData crearTicketObj(){
    ...
    return ApiData(
        urlServicio: RutaServicios.server + RutaServicios.estImssService,
        campos: campos
    );
  }
}