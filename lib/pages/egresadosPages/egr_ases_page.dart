...
import 'package:mesadeservicio/utils/widgets_egrAses.dart';
import 'package:mesadeservicio/routes/route_name.dart';

class EgrAsesPage extends StatelessWidget{
  final nombre = TextEditingController();
  final correo = TextEditingController();
  final usuario = TextEditingController();
  final curp = TextEditingController();
  final motivo = TextEditingController();
  final desGral = TextEditingController();
  final _ticketForm = GlobalKey<FormBuilderState>();
  final Tema tema;

  EgrAsesPage({super.key,required this.tema});
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 10),
                    WidgetsAsesCert.getMotivoAsesCert(motivo),
                    const SizedBox(height: 10),
                    Widgets.getFieldDescripcion(desGral),
                    const SizedBox(height: 10),
                    Row(
  ...
  ApiData crearTicketObj(){
    ...
    return ApiData(
        urlServicio: RutaServicios.server + RutaServicios.egrAsesService,
        campos: campos
    );
  }
}
