...
import 'package:mesadeservicio/utils/widgets_egrCorr.dart';
...
class EgrCorrPage extends StatelessWidget{
  ...
  EgrCorrPage({super.key,required this.tema});
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 10),
                    WidgetsCorrCert.getMotivoCorrCert(motivo),
                    const SizedBox(height: 10),
  ...
  ApiData crearTicketObj(){
    ...
    return ApiData(
        urlServicio: RutaServicios.server + RutaServicios.egrCorrService,
        campos: campos
    );
  }
}